    ...
    ui(new Ui::rubleInterbank)
{
    ...
    setWindowTitle(tr("Money Charts"));

    this->setFixedSize(225,100);
    this->setGeometry(QRect(93,100,225,100));
