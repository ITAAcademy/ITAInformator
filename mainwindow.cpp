...
void MainWindow::on_actionEn_triggered()
{
    ...
    QMessageBox::information(this,
                             tr("Change language"),
                             tr("For the complete translation of the program:\n"
                                "Close all additional windows"));
}

void MainWindow::on_actionUa_triggered()
{
    chLangUa();
    QMessageBox::information(this,
                             tr("Change language"),
...
void MainWindow::_initChartsVectorData()
{
    ...
    mvCharts.push_back(myURLDrahotsennemetals2);
}
...
void MainWindow::on_actionOil_graphics_triggered()
{
    formOilGraphics = new OilGraphics (this);
    formOilGraphics -> show();
}

void MainWindow::on_actionPrecious_metals_charts_triggered()
{
    formMetals = new Metals (this);
    formMetals -> show();
}
...
void MainWindow::reTranslateUi()
{
    ...
    ui->menuProgram->setTitle(tr("Program"));
        ...
        ui->menuInformers->setTitle(tr("Informers"));
            ui->action_Oil_Charts->setText(tr("&Oil Charts"));
            ui->action_Currency->setText(tr("&Currency"));
            ui->actionOil_graphics->setText(tr("&Oil graphics"));
            ui->actionPrecious_metals_charts->setText(tr("&Precious metals prices"));
